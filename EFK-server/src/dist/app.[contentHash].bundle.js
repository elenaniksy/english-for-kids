  ...
  var e = {
      ...
      752: function (e, t, s) {
        ...
        const i = s(403),
          ...
          r = s(748),
          o = 'train';
        class d extends i.BaseComponent {
          constructor(e) {
                    ...
                    (e.target.checked
                      ? ((this.mode = o),
                        ...
                        null === (s = this.header) ||
                          void 0 === s ||
                          s.changeSwitcher(),
                        null === (n = this.mainContainer) ||
                          void 0 === n ||
                          n.changeMode(this.mode))
                      : ((this.mode = 'play'),
                        null === (i = this.header) ||
                          void 0 === i ||
                          i.setMode(this.mode),
          ...
          renderMainContainer(e, t, s) {
            this.mainContainer = new r.MainContainer(e, t, s);
          }
          renderCards(e) {
            var t;
            null === (t = this.mainContainer) ||
              void 0 === t ||
              t.renderCardsByCategory(e);
          }
        }
        t.App = d;
      },
        ...
        class r extends i.BaseComponent {
          constructor(e) {
            super(e, 'div', ['card__container']),
              ...
              (this.buttonDelete = new i.BaseComponent(
                this.cardHolder,
                'button',
                ['button__delete'],
                '❌'
              ...
              (this.header = new i.BaseComponent(this.cardHolder, 'h3', [
                'card__header',
              ])),
              (this.cardButton = new i.BaseComponent(
                this.cardHolder,
                'button',
                ['card__button']
              )),
          ...
          renderCategory(e, t) {
            ...
            this.cardHolder.classList.add('column'),
              ...
              e.items &&
              0 !== (null === (s = e.items) || void 0 === s ? void 0 : s.length)
          ...
          renderBackSide(e) {
            ...
            (s.innerHTML = `${e.translation}`), this.cardBack.append(t, s);
          }
      ...
      977: (e, t, s) => {
        ...
        const n = s(403),
          i = s(658),
          a = s(709);
        class r extends n.BaseComponent {
          constructor(e, t, s) {
            super(e, 'header', ['header']),
              (this.parentNode = e),
              (this.mode = s),
              (this.navigation = new i.Navigation(this.element, t, this.mode)),
      ...
      565: (e, t, s) => {
        ...
        const n = s(403),
          i = s(991);
        class a extends n.BaseComponent {
          constructor(e, t, s) {
            super(e, 'div', ['menu-toggle']),
              ...
              (this.navigationList = new i.NavigationList(this.element, t, s));
          }
          render(e = []) {
        ...
        class a extends n.BaseComponent {
          constructor(e, t, s) {
            super(e, 'nav', ['navigation']),
              (this.parentNode = e),
              (this.menuToggle = new i.MenuToggle(this.element, t, s));
          }
          changeMenuColor(e) {
      ...
      81: (e, t, s) => {
        ...
        const n = s(403);
        class i extends n.BaseComponent {
          constructor(e, t) {
            super(e, 'li', ['navigation__item']),
              (this.parentNode = e),
              (this.innerLink = new n.BaseComponent(
                this.element,
                'a',
                ['navigation__link'],
                t
          ...
          renderList() {
            this.changeClassMode(this.mode),
              this.state.forEach((e) => {
                const t = new i.NavigationItem(this.element, e.category);
        ...
        class r extends n.BaseComponent {
          constructor(e) {
            super(e, 'div', ['cards-field']),
              ...
              (this.buttonStart = new n.BaseComponent(
                this.element,
                'button',
                ['button__start'],
                'Start game'
              ...
              (this.answers = 0),
              (this.cardsHtmlElements = []),
              (this.score = new n.BaseComponent(this.element, 'div', [
                'score',
              ])),
          ...
          addCardsCategory(e, t) {
            this.element.before(this.overlay.element),
              ...
              this.cards.forEach((e) => {
                new i.Card(this.element).renderCategory(e, t);
              }),
              (new i.Card(this.element).renderCreateCard().onclick = () => {
            ...
            this.clear(),
              ...
              this.cards.forEach((e) => {
                e.category === s &&
                  ...
                  e.items.forEach((e) => {
                    const s = new i.Card(this.element).renderItem(e, t);
                    this.cardsHtmlElements.push(s);
                  }));
              }),
              'play' === t &&
          ...
          renderEndGame() {
            ...
            const e = new n.BaseComponent(this.element, 'h1', [
                'header__final',
              ]),
              t = document.createElement('img');
            t.classList.add('img__final'), (t.src = '');
            const s = new n.BaseComponent(
              this.element,
              'button',
              ['button__restart'],
              'Try again!'
        ...
        class a extends n.BaseComponent {
          constructor(e, t, s) {
            super(e, 'div', ['main-container']),
              ...
              (this.mode = s),
              (this.state = t),
              (this.cardField = new i.CardField(this.element)),
      ...
      189: (e, t, s) => {
        ...
        class i extends n.BaseComponent {
          constructor(e) {
            super(e, 'div', ['modal']),
              (this.parentNode = e),
              (this.header = new n.BaseComponent(
                this.element,
                'h2',
                ['modal__header'],
                'Your Category'
              )),
              (this.form = new n.BaseComponent(this.element, 'form', ['form'])),
              (this.nameInput = new n.BaseComponent(this.element, 'input', [
                'modal__input',
              ])),
              (this.data = { category: '' }),
              ...
              (this.buttonSave = new n.BaseComponent(
                this.element,
                'input',
                ['button__save'],
                'Send'
        ...
        class a extends n.BaseComponent {
          constructor(e) {
            super(e, 'div', ['overlay', 'overlay_hidden']),
              (this.parentNode = e),
              (this.modal = new i.Modal(this.element));
          }
        }
        t.Overlay = a;
      },
      ...
      453: (e, t, s) => {
        e.exports = s.p + 'src/assets//noImage.png';
      },
    },
    t = {};
  function s(n) {
  ...
  (s.g = (function () {
    ...
    (() => {
      ...
      window.onload = () => {
        ...
        const s = new e.App(document.body),
          i = new t.Router({ mode: 'hash', root: '/' });
        n.forEach((e) => {
          i.add(`#${e}`, () => {
            s.renderCards(e);
          });
